...
export const MARKETS = [
  ...
  'Spokane WA','Milwaukee WI','Conway SC','Lynchburg VA',
...
export const emptyDeal = () => ({
  address: '', city: '', state: '', market: MARKETS[0], status: 'tracked',
