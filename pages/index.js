...
// ─── HOME PAGE ───
function HomePage({ deals, setActiveTab }) {
    ...
    <div>
      ...
      <div style={{ display: 'flex', gap: 14, flexWrap: 'wrap' }}>
        ...
        <div style={{ flex: '1 1 250px' }}>
          <div style={{ fontSize: 13, fontWeight: 700, color: B.blue, fontFamily: hf, textTransform: 'uppercase', marginBottom: 8 }}>Owned properties</div>
          {owned.length === 0 ? (
      ...
      <div style={{ marginLeft: 170, flex: 1, padding: '16px 20px', minWidth: 0 }}>
        ...
        {loading ? (
          ...
          <>
            ...
            {activeTab === 'home' && <HomePage deals={deals} setActiveTab={setActiveTab} />}
